...
export async function sendPriceDropAlert(
  ...
  try {
    ...
    // Use Resend's test domain for free tier, or your verified domain
      ...
      html: `
        ...
        <html>
          ...
          <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: linear-gradient(135deg, #2D7CFD 0%, #74D4FF 100%); padding: 30px; border-radius: 10px 10px 0 0; text-align: center;">
            ...
            <div style="background: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 10px 10px;">
              ...
              <div style="background: #B8E6FE; border-left: 4px solid #2D7CFD; padding: 15px; margin: 20px 0; border-radius: 4px;">
              ...
              <table style="width: 100%; margin: 20px 0;">
                ...
                <tr>
                  <td style="padding: 10px;">
                    ...
                    <div style="font-size: 32px; color: #7ED7FF; font-weight: bold;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="${product.url}" 
                   style="display: inline-block; background: #2D7CFD; color: white; padding: 14px 30px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">
                  View Product →
                </a>
              </div>
              ...
              <div style="border-top: 1px solid #e5e7eb; padding-top: 20px; margin-top: 20px; text-align: center; color: #6b7280; font-size: 12px;">
                ...
                <p style="margin-top: 10px;">
                  ...
                  }" style="color: #2D7CFD; text-decoration: none;">
